...
> This document describes the Code of Conduct for [@kilobravo-ai](https://github.com/kilobravo-ai).
...
To report instances of abusive, harassing, or otherwise unacceptable behavior, email `team [at] kilobravo.ai` and include the word `CONDUCT` in the subject line.
